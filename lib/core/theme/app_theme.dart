...
class AppTheme {
  // Innovative Color Palette - Rare and Modern Combinations
  static const Color primaryPurple = Color(0xFF6B46C1); // Deep purple
  static const Color primaryTeal = Color(0xFF0891B2); // Vibrant teal
  static const Color accentCoral = Color(0xFFFF6B6B); // Warm coral
  static const Color accentGold = Color(0xFFFFD93D); // Bright gold
  static const Color accentEmerald = Color(0xFF10B981); // Emerald green
  static const Color accentRose = Color(0xFFEC4899); // Hot pink

  // Dark theme colors
  static const Color darkSurface = Color(0xFF0F0F23); // Deep navy
  static const Color darkCard = Color(0xFF1A1A2E); // Darker navy
  static const Color darkAccent = Color(0xFF16213E); // Blue-gray

  // Light theme colors
  static const Color lightSurface = Color(0xFFFAFAFA); // Off-white
  static const Color lightCard = Color(0xFFFFFFFF); // Pure white
  static const Color lightAccent = Color(0xFFF8FAFC); // Light gray
