...
class _EventsMyEventsScreenState extends State<EventsMyEventsScreen>
  ...
  // Get created events (events created by current user)
  ...
  // Get registered events - will be populated via FutureBuilder
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              // Update registered events when controller events change
