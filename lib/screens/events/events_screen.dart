...
class _EventsScreenState extends State<EventsScreen>
  ...
  final List<EventItem> _events = [
    EventItem(
      ...
      imageUrl: 'https://placehold.co/400x300?text=Hackathon',
    ...
    EventItem(
      ...
      imageUrl: 'https://placehold.co/400x300?text=Career+Fair',
    ...
    EventItem(
      ...
      imageUrl: 'https://placehold.co/400x300?text=Welcome+Party',
    ...
    EventItem(
      ...
      imageUrl: 'https://placehold.co/400x300?text=Tech+Talk',
