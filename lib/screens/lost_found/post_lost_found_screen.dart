  ...
  Future<void> _pickImage() async {
    try {
      ...
      if (image != null) {
        ...
        // Auto-run AI detection when image is selected
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          // Auto-fill category and color based on AI detection
          if (detectedLabel != null) {
            _selectedCategory = AIService.mapLabelToCategory(detectedLabel);
          }
          if (detectedColor != null) {
            _selectedColor = AIService.mapColorToDropdown(detectedColor);
          }
        });
