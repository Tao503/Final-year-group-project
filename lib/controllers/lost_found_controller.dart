  ...
  Future<bool> postItem({
    ...
    try {
      ...
      if (imageFile != null) {
        ...
        print('📤 Controller: Image URL: $imageUrl');
        
        print('🤖 Controller: Detecting label...');
        detectedLabel = await AIService.detectItemLabel(imageFile);
        print('🤖 Controller: Detected label: $detectedLabel');
        
        print('🎨 Controller: Detecting color...');
        detectedColor = await AIService.detectColor(imageFile);
        print('🎨 Controller: Detected color: $detectedColor');
      }

      print('📝 Controller: Submitting item: Title=$title, Category=$category, Color=${color ?? detectedColor}');
      ...
      print('✅ Controller: Item insert SUCCESSFUL');
      await fetchItems();
